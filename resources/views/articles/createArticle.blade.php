                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form action="{{ route('article.store') }}" method="post" >
                            ...
                            <div class="form-group">
                                <label for="publishedname">Nashrni tanlang</label>
                                <select name="publishedname" id="publishedname" class="select custom-select">
                                    @foreach ($publishedList as $published)
                                        <option value="{{ $published->id }}"> {{ $published->publishname }}  {{ $published->tom}}-tom  {{ $published->number}}-son  {{ $published->date }} </option>
                                    @endforeach
                                </select>
                            </div>
