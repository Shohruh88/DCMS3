...
<head>
    ...
    <link rel="stylesheet" href="{{asset('pdf_viewers/pdfjs/viewer.css')}}"/>
    <link rel="stylesheet" href="{{ asset('pdf_viewers/pdf-flip.css') }}"/>
    <style>
        .se-pre-con {
            position: fixed;
            left: 0px;
            ...
            height: 100%;
            z-index: 9999;
            background: url("{{ asset('pdf_viewers/pics/loader.gif') }}") center no-repeat #fff;
        }
    </style>
</head>
...
<script url="/public/file/{{ $file[0]->file }}" id="url"></script>
<script src="{{ asset('pdf_viewers/pdfjs/compatibility.js') }}"></script>
<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n" href="{{ asset('pdf_viewers/pdfjs/locale/locale.properties') }}"/>

<script src="{{ asset('js/ajax.min.js') }}"></script>
<script src="{{ asset('pdf_viewers/turnjs/turn.min.js') }}"></script>
<script src="{{ asset('pdf_viewers/turnjs/zoom.min.js') }}"></script>
<script src="{{ asset('pdf_viewers/pdfjs/l10n.js') }}"></script>
<script src="{{ asset('pdf_viewers/pdfjs/build/pdf.js') }}"></script>
<script src="{{ asset('pdf_viewers/pdfjs/debugger.js') }}"></script>
<script src="{{ asset('pdf_viewers/pdfjs/viewer.js') }}"></script>
<script src="{{ asset('pdf_viewers/pdf-flip.js?v=1.1.1.1.1.1') }}"></script>
<!-- <script src="{{ asset('pdf_viewers/pdfjs/build/pdf.worker.js') }}"></script> -->
