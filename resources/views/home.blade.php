...
<body style="overflow-x: hidden;">
    ...
    <section>
        <div class="container-fluid mt-1 px-4" style="width: 100%; height: 200px;">
            <div class="row">
    ...
    <section>
        <div class="container-fluid mt-3">
            <div class="row">
                <div class="col"><p style="font-weight: 500; font-size: 24px; line-height: 28px;margin-bottom:20px;">Diqqatdagilar</p></div>
            </div>
        </div>
        <div class="container">
            <div class="row">
...
<section>
  <div class="container-fluid mt-3">
    <div class="row">
        <div class="col-md-12"><p style="font-weight: 500; font-size: 24px; line-height: 28px;">Рубрики</p></div>
